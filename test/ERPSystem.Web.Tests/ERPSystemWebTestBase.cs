...
{
    public abstract class ERPSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ERPSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ERPSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ERPSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ERPSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ERPSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ERPSystemDbContext, Task<T>> func)
        {
            T result;
